...
export function createRoutes(
  ...
  router.get('/api/organizations/:orgId/roles', async (req: Request, res: Response) => {
    try {
      const { orgId } = req.params;
      const adapter = await getAuthAdapterWithConfig();
  ...
  router.post('/api/organizations/:orgId/roles', async (req: Request, res: Response) => {
    try {
      const { orgId } = req.params;
  ...
  router.put('/api/organizations/:orgId/roles/:roleId', async (req: Request, res: Response) => {
    try {
  ...
  router.delete('/api/organizations/:orgId/roles/:roleId', async (req: Request, res: Response) => {
    try {
      const { orgId, roleId } = req.params;
  ...
  router.put('/api/organizations/:orgId/members/:memberId/role', async (req: Request, res: Response) => {
    try {
  ...
  router.get('/api/plugins/organization/roles-config', async (_req: Request, res: Response) => {
    try {
      const authConfigPath = configPath || (await findAuthConfigPath());
      if (!authConfigPath) {
        return res.json({
