      ...
      <div className="bg-black border border-white/15 rounded-none w-full max-w-5xl shadow-2xl max-h-[95vh] overflow-y-auto">
        ...
        <div className="p-4 md:p-6 space-y-4">
          ...
          >
            ...
            <div className="absolute top-0 left-0 w-[20px] h-[0.5px] bg-white/20" />
            <div className="absolute top-0 left-0 w-[0.5px] h-[20px] bg-white/20" />
            <div className="absolute top-0 right-0 w-[20px] h-[0.5px] bg-white/20" />
            <div className="absolute top-0 right-0 w-[0.5px] h-[20px] bg-white/20" />
            <div className="absolute bottom-0 left-0 w-[20px] h-[0.5px] bg-white/20" />
            <div className="absolute bottom-0 left-0 w-[0.5px] h-[20px] bg-white/20" />
            <div className="absolute bottom-0 right-0 w-[20px] h-[0.5px] bg-white/20" />
            <div className="absolute bottom-0 right-0 w-[0.5px] h-[20px] bg-white/20" />
