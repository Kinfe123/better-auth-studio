  ...
  return (
    <div className="flex flex-col min-h-0 h-full">
      <div className="flex items-center justify-between gap-2 mb-1 shrink-0">
        <h4 className="text-xs text-gray-400 uppercase font-mono font-light tracking-wide">Recent Teams</h4>
          ...
          <table className="w-full text-[11px] border-collapse">
            ...
            <tbody>
              {teams.slice(0, 10).map((t) => (
                ...
                >
                  <td className="py-1.5 px-1.5 text-gray-300 group-hover:text-white truncate max-w-[160px] transition-colors" title={t.name || ""}>
                    {t.name || t.slug || "—"}
                  </td>
