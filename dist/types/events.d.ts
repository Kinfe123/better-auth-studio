export type AuthEventType = 'user.joined' | 'user.logged_in' | 'user.updated' | 'user.logged_out' | 'user.password_changed' | 'user.email_verified' | 'user.banned' | 'user.unbanned' | 'user.deleted' | 'organization.created' | 'organization.deleted' | 'organization.updated' | 'member.added' | 'member.removed' | 'member.role_changed' | 'session.created' | 'session.ended' | 'login.failed' | 'password.reset_requested' | 'password.reset_completed' | 'oauth.linked' | 'oauth.unlinked' | 'team.created' | 'team.updated' | 'team.deleted' | 'team.member.added' | 'team.member.removed' | 'invitation.created' | 'invitation.accepted' | 'invitation.rejected' | 'invitation.cancelled';
